...
#
# Script generated by Vivado on Wed Jan 21 10:50:44 +1100 2026
...
#
# Usage        : clk_25MHz.sh
#                clk_25MHz.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                clk_25MHz.sh [-reset_run]
#                clk_25MHz.sh [-reset_log]
#                clk_25MHz.sh [-help]
#
...
export RDI_DATADIR="D:/XilinxSoftware/2025.1/Vivado/data"

# set xvlog options
xvlog_opts="--incr --relax "

# script info
echo -e "clk_25MHz.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./clk_25MHz.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot clk_25MHz xil_defaultlib.clk_25MHz xil_defaultlib.glbl -log elaborate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/XilinxSoftware/2025.1/Vivado/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb clk_25MHz.wdb xsim.dir libdpi.so)
...
Usage: clk_25MHz.sh [-step]\n\
Usage: clk_25MHz.sh [-lib_map_path]\n\
Usage: clk_25MHz.sh [-reset_run]\n\
Usage: clk_25MHz.sh [-reset_log]\n\
Usage: clk_25MHz.sh [-keep_index]\n\
