...
REM
REM Generated by Vivado on Wed Jan 21 11:57:45 +1100 2026
...
echo "xvlog --incr --relax -prj tb_vga_top_vlog.prj"
call xvlog  --incr --relax -prj tb_vga_top_vlog.prj -log xvlog.log
